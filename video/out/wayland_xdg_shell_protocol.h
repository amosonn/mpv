 ...
 * @configure: suggest a surface chnage
...
#define XDG_SURFACE_SET_MAXIMIZED	8
#define XDG_SURFACE_UNSET_MAXIMIZED	9
#define XDG_SURFACE_SET_FULLSCREEN	10
#define XDG_SURFACE_UNSET_FULLSCREEN	11
